 ...
 */
public class LinearBidToPositionModel1_6 extends BidToPositionModel {
	static double POS_DISTANCE = (1.0/6);
	...
	public LinearBidToPositionModel1_6(Set<Query> space, int slots) {
	...
	public String toString() {
		return "LinearBidToPositionModel1_6";
	}
}
