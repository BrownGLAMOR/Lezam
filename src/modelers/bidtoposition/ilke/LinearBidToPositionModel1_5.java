 ...
 */
public class LinearBidToPositionModel1_5 extends BidToPositionModel {
	static double POS_DISTANCE = (1.0/5);
	...
	public LinearBidToPositionModel1_5(Set<Query> space, int slots) {
	...
	public String toString() {
		return "LinearBidToPositionModel1_5";
	}
}
