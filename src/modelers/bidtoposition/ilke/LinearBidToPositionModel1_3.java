 ...
 */
public class LinearBidToPositionModel1_3 extends BidToPositionModel {
	static double POS_DISTANCE = (1.0/3);
	...
	public LinearBidToPositionModel1_3(Set<Query> space, int slots) {
	...
	public String toString() {
		return "LinearBidToPositionModel1_3";
	}
}
