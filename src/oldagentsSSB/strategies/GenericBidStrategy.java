...
public class GenericBidStrategy {
   ...
   public void setQuerySpendLimit(Query q, double d) {
      _querySpendLimit.put(q, d);
   }

   public void setQueryAd(Query q, Ad d) {
      _queryAd.put(q, d);
   }

   public void setCampaignSpendLimit(double campaignSpendLimit) {
      _campaignSpendLimit = campaignSpendLimit;
   }

   public void setDefaultQuerySpendLimit(double d) {
      _defaultQuerySpendLimit = d;
   }

   public void setDefaultQueryAd(Ad d) {
      _defaultQueryAd = d;
   }
