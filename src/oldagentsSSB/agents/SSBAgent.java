...
import oldagentsSSB.agents.rules.AdjustConversionPr;
import oldagentsSSB.agents.rules.ConversionPr;
import oldagentsSSB.agents.rules.DistributionCap;
import oldagentsSSB.agents.rules.ManufacurerBonus;
import oldagentsSSB.agents.rules.NoImpressions;
import oldagentsSSB.agents.rules.ReinvestmentCap;
import oldagentsSSB.agents.rules.Targeted;
import oldagentsSSB.agents.rules.TopPosition;
import oldagentsSSB.agents.rules.Walking;
import oldagentsSSB.oldmodels.conversionprob.ConversionPrModel;
import oldagentsSSB.oldmodels.conversionprob.ConversionPrModelNoIS;
import oldagentsSSB.oldmodels.unitssold.UnitsSoldModel;
import oldagentsSSB.oldmodels.unitssold.UnitsSoldModelMean;
