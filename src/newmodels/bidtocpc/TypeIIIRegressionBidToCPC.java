...
public class TypeIIIRegressionBidToCPC extends AbstractBidToCPC {
	...
	public TypeIIIRegressionBidToCPC(RConnection rConnection, Set<Query> queryspace, Query query, int IDVar, int numPrevDays, boolean powers) {
		c = rConnection;
...
//				e.printStackTrace();
	...
	public AbstractModel getCopy() {
		return new TypeIIIRegressionBidToCPC(c, _querySpace, _query, _IDVar, _numPrevDays, _powers);
	}
}