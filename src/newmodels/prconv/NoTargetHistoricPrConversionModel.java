...
public class NoTargetHistoricPrConversionModel extends NewAbstractConversionModel {
	...
	public NoTargetHistoricPrConversionModel(Set<Query> querySpace, BasicTargetModel targModel) {
		_math = new PrMath();
	...
	public NoTargetHistoricPrConversionModel() {
		_math = new PrMath();
	}
