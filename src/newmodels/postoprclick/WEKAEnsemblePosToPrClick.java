...
public class WEKAEnsemblePosToPrClick extends AbstractPosToPrClick {
	...
	public AbstractModel getCopy() {
		return new WEKAEnsemblePosToPrClick(_querySpace, NUMPASTDAYS, ENSEMBLESIZE, _targModel, _borda, _ignoreNaN);
	}
