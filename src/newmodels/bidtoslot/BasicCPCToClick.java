...
public class BasicCPCToClick {
	...
	//The click function is psi*e^{zeta*bid}
	// or psi + zeta*bid
	double PSI, ZETA;
	
	//ClickGivenBid is a separate calculation for each query, so we instantiate it
	//with a specific query
	public BasicCPCToClick(Query q, boolean isLogLinear) {
		_query = q;
