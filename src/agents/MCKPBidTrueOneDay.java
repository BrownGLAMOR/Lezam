 ...
 *
 */
public class MCKPBidTrueOneDay extends AbstractAgent {
...
//			System.out.println(numIters);
	...
	public String toString() {
		return "MCKPBidTrueOneDay";
	}

	@Override
	public AbstractAgent getCopy() {
		return new MCKPBidTrueOneDay();
	}
