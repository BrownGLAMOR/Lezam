...
public class EquatePRSimple extends RuleBasedAgentSimple {
   ...
   public EquatePRSimple() {
      this(4.9376620170349348, 1.06, 1.35);
//		this(3.80653, 1.06, 1.35);
   }

   public EquatePRSimple(double initPR,
                         double incPR,
                         double lambdaCap) {
      _initPR = initPR;
      _incPR = incPR;
   ...
   public AbstractAgent getCopy() {
      return new EquatePRSimple(_initPR, _incPR, _lambdaCap);
   }
