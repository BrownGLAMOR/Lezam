...
public class EquateROISimple extends RuleBasedAgentSimple {
	...
	public EquateROISimple() {
		this(3.9376620170349352, 1.02, 1.35);
//		this(4.0, 1.02, 1.35);
	}
	
	public EquateROISimple(double initROI,
			double incROI,
			double lambdaCap) {
		_initROI = initROI;
		_incROI = incROI;
	...
	public AbstractAgent getCopy() {
		return new EquateROISimple(_initROI, _incROI, _lambdaCap);
	}
