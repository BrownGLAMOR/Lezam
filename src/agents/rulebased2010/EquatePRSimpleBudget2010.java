...
public class EquatePRSimpleBudget2010 extends RuleBasedAgentSimple2010 {
   protected double _PR;
   protected double _initPR;
   protected double _incPR;
   protected double _decPR;

   public EquatePRSimpleBudget2010() {
      this(4.9376620170349348, 1.06, 1.35);
   }

   public EquatePRSimpleBudget2010(double initPR,
                                   double incPR,
                                   double lambdaCap) {
      _initPR = initPR;
      _incPR = incPR;
   ...
   public AbstractAgent getCopy() {
      return new EquatePRSimpleBudget2010(_initPR, _incPR, _lambdaCap);
   }
