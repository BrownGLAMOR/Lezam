...
public class EquateROISimple2010 extends RuleBasedAgentSimple2010 {
	protected double _ROI;
	protected double _initROI;
	protected double _incROI;
	protected double _decROI;
	
	public EquateROISimple2010() {
		this(3.9376620170349352, 1.02, 1.35);
	}
	
	public EquateROISimple2010(double initROI,
			double incROI,
			double lambdaCap) {
		_initROI = initROI;
		_incROI = incROI;
	...
	public AbstractAgent getCopy() {
		return new EquateROISimple2010(_initROI, _incROI, _lambdaCap);
	}
