...
public class EquatePPSSimple2010 extends RuleBasedAgentSimple2010 {
   protected double _PPS;
   protected double _initPPS;
   protected double _incPPS;
   protected double _decPPS;

   public EquatePPSSimple2010() {
      this(9.9684, 1.03, 1.375);
   }

   public EquatePPSSimple2010(double initPPS,
                              double incPPS,
                              double lambdaCap) {
      _initPPS = initPPS;
      _incPPS = incPPS;
   ...
   public AbstractAgent getCopy() {
      return new EquatePPSSimple2010(_initPPS, _incPPS, _lambdaCap);
   }
