...
public class EquatePMSimpleBudget2010 extends RuleBasedAgentSimple2010 {
	protected double _PM;
	protected double _initPM;
	protected double _incPM;
	protected double _decPM;
	
	public EquatePMSimpleBudget2010() {
		this(0.797475,1.02,1.525);
	}

	public EquatePMSimpleBudget2010(double initPM,
			double incPM,
			double lambdaCap) {
		_initPM = initPM;
		_incPM = incPM;
	...
	public AbstractAgent getCopy() {
		return new EquatePMSimpleBudget2010(_initPM, _incPM, _lambdaCap);
	}
