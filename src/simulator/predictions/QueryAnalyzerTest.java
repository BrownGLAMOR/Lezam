...
//                              System.out.println(rankPredMap);
   ...
   */
   ...
   public static void main(String[] args) throws IOException, ParseException {
      ...
      evaluator.queryAnalyzerPredictionChallenge(new CarletonQueryAnalyzer(querySpace, advertisers, "this will be overwritten", LDS_ITERATIONS_1, LDS_ITERATIONS_2, REPORT_FULLPOS_FORSELF, true));
