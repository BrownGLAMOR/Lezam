 ...
 *
 */
public class ImpressionEstimationLPAll {
	...
	public ImpressionEstimationLPAll(int M, int us, int imp, double[] knownI_a, double[] knownMu_a, double[] knownSampledMu_a, int numSlots, double[] T_aPriorMean, double[] T_aPriorStdev) {
		_M = M;
		_us = us;
		_imp = imp;
...
//		CarletonLP.solveIt(numSlots, avgPos_a, M, us, imp, dropout_a, bestObj);
		...
		ImpressionEstimationLPAll carletonLP = new ImpressionEstimationLPAll(M, us, imp, knownI_a, knownMu_a, knownSampledMu_a, numSlots, T_aPriorMean, T_aPriorStdev);
