...
public class NaiveImpressionForecaster extends AbstractImpressionForecaster {
   ...
   public NaiveImpressionForecaster(Set<Query> querySpace, String[] agents, int ourIdx) {
   ...
   public AbstractModel getCopy() {
      return new NaiveImpressionForecaster(_querySpace, _agents, _ourIdx);
   }
}
