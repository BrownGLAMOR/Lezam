...
public class KitchenSinkEnsembleBidToCPC extends AbstractBidToCPC {
	...
	public KitchenSinkEnsembleBidToCPC(Set<Query> querySpace, int numPastDays, int ensembleSize, boolean borda, boolean ignoreNaN) {
	...
	public AbstractModel getCopy() {
		return new KitchenSinkEnsembleBidToCPC(_querySpace, NUMPASTDAYS, ENSEMBLESIZE, _borda, _ignoreNaN);
	}
