...
public class WEKABidToCPCPerQuery extends AbstractBidToCPC {
   ...
   public String toString() {
      switch (_idx) {
         case 1:
            return "WEKABidToCPCPerQuery(LinearRegression), weight: " + _weight + ", maxDays: " + _maxDays + ")";
         case 2:
            return "WEKABidToCPCPerQuery(IBk):weight: " + _weight + ", maxDays: " + _maxDays + ")";
         case 3:
            return "WEKABidToCPCPerQuery(KStar):weight: " + _weight + ", maxDays: " + _maxDays + ")";
         case 4:
            return "WEKABidToCPCPerQuery(LWL):weight: " + _weight + ", maxDays: " + _maxDays + ")";
         case 5:
            return "WEKABidToCPCPerQuery(AdditiveRegression):weight: " + _weight + ", maxDays: " + _maxDays + ")";
         case 6:
            return "WEKABidToCPCPerQuery(REPTree):weight: " + _weight + ", maxDays: " + _maxDays + ")";
         case 7:
            return "WEKABidToCPCPerQuery(RegressionByDiscretization):weight: " + _weight + ", maxDays: " + _maxDays + ")";
         default:
            return "WEKABidToCPCPerQuery(LinearRegression):weight: " + _weight + ", maxDays: " + _maxDays + ")";
      }
   }
