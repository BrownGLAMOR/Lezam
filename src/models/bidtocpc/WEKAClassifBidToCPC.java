...
public class WEKAClassifBidToCPC extends AbstractBidToCPC {
   ...
   public WEKAClassifBidToCPC(int idx) {
      _idx = idx;
...
//			System.out.println("bid: " + bid + ", prediction: " +prediction + ", mean or mode: ");
   ...
   public String toString() {
      switch (_idx) {
         case 1:
            return "WEKAClassifBidToCPC(BayesNet)";
         case 2:
            return "WEKAClassifBidToCPC(NaiveBayes)";
         case 3:
            return "WEKAClassifBidToCPC(IBk)";
         case 4:
            return "WEKAClassifBidToCPC(KStar)";
         case 5:
            return "WEKAClassifBidToCPC(LWL)";
         case 6:
            return "WEKAClassifBidToCPC(AttributeSelectedClassifier)";
         case 7:
            return "WEKAClassifBidToCPC(Bagging)";
         case 8:
            return "WEKAClassifBidToCPC(LogitBoost)";
         case 9:
            return "WEKAClassifBidToCPC(RandomCommittee)";
         case 10:
            return "WEKAClassifBidToCPC(DecisionTable)";
         case 11:
            return "WEKAClassifBidToCPC(DTNB)";
         case 12:
            return "WEKAClassifBidToCPC(NNge)";
         case 13:
            return "WEKAClassifBidToCPC(OneR)";
         case 14:
            return "WEKAClassifBidToCPC(PART)";
         case 15:
            return "WEKAClassifBidToCPC(J48)";
         case 16:
            return "WEKAClassifBidToCPC(J48graft)";
         case 17:
            return "WEKAClassifBidToCPC(NBTree)";
         case 18:
            return "WEKAClassifBidToCPC(RandomForest)";
         case 19:
            return "WEKAClassifBidToCPC(REPTree)";
         default:
            return "WEKAClassifBidToCPC(NaiveBayes)";
      }
   }
...
//			e1.printStackTrace();
   ...
   public AbstractModel getCopy() {
      return new WEKAClassifBidToCPC(_idx);
   }
}
