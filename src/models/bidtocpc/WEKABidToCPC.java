...
public class WEKABidToCPC extends AbstractBidToCPC {
   ...
   public String toString() {
      switch (_idx) {
         case 1:
            return "WEKABidToCPC(LinearRegression), weight: " + _weight + ")";
         case 2:
            return "WEKABidToCPC(IBk): " + _weight + ")";
         case 3:
            return "WEKABidToCPC(KStar): " + _weight + ")";
         case 4:
            return "WEKABidToCPC(LWL): " + _weight + ")";
         case 5:
            return "WEKABidToCPC(AdditiveRegression): " + _weight + ")";
         case 6:
            return "WEKABidToCPC(REPTree): " + _weight + ")";
         case 7:
            return "WEKABidToCPC(RegressionByDiscretization): " + _weight + ")";
         default:
            return "WEKABidToCPC(LinearRegression): " + _weight + ")";
      }
   }
