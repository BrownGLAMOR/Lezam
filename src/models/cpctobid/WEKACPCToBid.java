...
public class WEKACPCToBid extends AbstractCPCToBid {
   ...
   public String toString() {
      switch (_idx) {
         case 1:
            return "WEKACPCToBid(LinearRegression), weight: " + _weight + ")";
         case 2:
            return "WEKACPCToBid(IBk): " + _weight + ")";
         case 3:
            return "WEKACPCToBid(KStar): " + _weight + ")";
         case 4:
            return "WEKACPCToBid(LWL): " + _weight + ")";
         case 5:
            return "WEKACPCToBid(AdditiveRegression): " + _weight + ")";
         case 6:
            return "WEKACPCToBid(REPTree): " + _weight + ")";
         case 7:
            return "WEKACPCToBid(RegressionByDiscretization): " + _weight + ")";
         default:
            return "WEKACPCToBid(LinearRegression): " + _weight + ")";
      }
   }
