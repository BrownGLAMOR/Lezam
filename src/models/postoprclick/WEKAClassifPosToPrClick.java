...
//			System.out.println("bid: " + bid + ", prediction: " +prediction + ", mean or mode: ");
   ...
   public String toString() {
      switch (_idx) {
         case 1:
            return "WEKAClassifPosToPrClick(BayesNet)";
         case 2:
            return "WEKAClassifPosToPrClick(NaiveBayes)";
         case 3:
            return "WEKAClassifPosToPrClick(IBk)";
         case 4:
            return "WEKAClassifPosToPrClick(KStar)";
         case 5:
            return "WEKAClassifPosToPrClick(LWL)";
         case 6:
            return "WEKAClassifPosToPrClick(AttributeSelectedClassifier)";
         case 7:
            return "WEKAClassifPosToPrClick(Bagging)";
         case 8:
            return "WEKAClassifPosToPrClick(LogitBoost)";
         case 9:
            return "WEKAClassifPosToPrClick(RandomCommittee)";
         case 10:
            return "WEKAClassifPosToPrClick(DecisionTable)";
         case 11:
            return "WEKAClassifPosToPrClick(DTNB)";
         case 12:
            return "WEKAClassifPosToPrClick(NNge)";
         case 13:
            return "WEKAClassifPosToPrClick(OneR)";
         case 14:
            return "WEKAClassifPosToPrClick(PART)";
         case 15:
            return "WEKAClassifPosToPrClick(J48)";
         case 16:
            return "WEKAClassifPosToPrClick(J48graft)";
         case 17:
            return "WEKAClassifPosToPrClick(NBTree)";
         case 18:
            return "WEKAClassifPosToPrClick(RandomForest)";
         case 19:
            return "WEKAClassifPosToPrClick(REPTree)";
         default:
            return "WEKAClassifPosToPrClick(NaiveBayes)";
      }
   }
