...
public class KitchenSinkEnsemblePosToPrClick extends AbstractPosToPrClick {
	...
	public KitchenSinkEnsemblePosToPrClick(Set<Query> querySpace, int numPastDays, int ensembleSize, BasicTargetModel targModel, boolean borda, boolean ignoreNaN) {
	...
	public void initializeEnsemble() {
		...
		addModel(new RegressionPosToPrClick(_rConnection, _querySpace, false,3,40, _targModel, true,0.99, false, true, false, true));
		addModel(new RegressionPosToPrClick(_rConnection, _querySpace, false,3,40, _targModel, false,0.84, false, true, false, true));
		addModel(new RegressionPosToPrClick(_rConnection, _querySpace, false,3,60, _targModel, false,0.84, false, true, false, true));
		addModel(new RegressionPosToPrClick(_rConnection, _querySpace, false,1,20, _targModel, true,0.99, false, true, false, true));
		addModel(new RegressionPosToPrClick(_rConnection, _querySpace, false,1,20, _targModel, false,0.84, false, true, false, true));
		addModel(new RegressionPosToPrClick(_rConnection, _querySpace, false,1,20, _targModel, true,0.915, false, true, false, true));
		addModel(new RegressionPosToPrClick(_rConnection, _querySpace, false,1,60, _targModel, true,0.84, false, true, false, true));
		addModel(new RegressionPosToPrClick(_rConnection, _querySpace, false,1,40, _targModel, true,0.84, false, true, false, true));
		addModel(new RegressionPosToPrClick(_rConnection, _querySpace, false,1,20, _targModel, true,0.84, false, true, false, true));
		addModel(new RegressionPosToPrClick(_rConnection, _querySpace, false,3,60, _targModel, true,0.915, false, true, false, true));
		addModel(new RegressionPosToPrClick(_rConnection, _querySpace, false,3,40, _targModel, true,0.915, false, true, false, true));
		addModel(new RegressionPosToPrClick(_rConnection, _querySpace, true,1,60, _targModel, true,0.84, false, false, false, false));
		addModel(new RegressionPosToPrClick(_rConnection, _querySpace, false,3,20, _targModel, true,0.99, false, true, false, true));
		addModel(new RegressionPosToPrClick(_rConnection, _querySpace, false,3,20, _targModel, false,0.84, false, true, false, true));
		addModel(new RegressionPosToPrClick(_rConnection, _querySpace, true,1,40, _targModel, true,0.84, false, false, false, false));
		addModel(new RegressionPosToPrClick(_rConnection, _querySpace, false,3,20, _targModel, true,0.915, false, true, false, true));
		addModel(new RegressionPosToPrClick(_rConnection, _querySpace, false,3,60, _targModel, true,0.84, false, true, false, true));
		addModel(new RegressionPosToPrClick(_rConnection, _querySpace, false,3,40, _targModel, true,0.84, false, true, false, true));
		addModel(new RegressionPosToPrClick(_rConnection, _querySpace, false,1,60, _targModel, true,0.99, false, true, false, false));
		addModel(new RegressionPosToPrClick(_rConnection, _querySpace, false,1,40, _targModel, true,0.99, false, true, false, false));
		addModel(new RegressionPosToPrClick(_rConnection, _querySpace, false,1,60, _targModel, true,0.915, false, true, false, false));
		addModel(new RegressionPosToPrClick(_rConnection, _querySpace, false,1,40, _targModel, false,0.84, false, true, false, false));
		addModel(new RegressionPosToPrClick(_rConnection, _querySpace, false,1,60, _targModel, false,0.84, false, true, false, false));
		addModel(new RegressionPosToPrClick(_rConnection, _querySpace, false,1,40, _targModel, true,0.915, false, true, false, false));
		addModel(new RegressionPosToPrClick(_rConnection, _querySpace, false,3,20, _targModel, true,0.84, false, true, false, true));
		addModel(new RegressionPosToPrClick(_rConnection, _querySpace, false,1,20, _targModel, true,0.99, false, true, false, false));
		addModel(new RegressionPosToPrClick(_rConnection, _querySpace, false,1,20, _targModel, false,0.84, false, true, false, false));
		addModel(new RegressionPosToPrClick(_rConnection, _querySpace, false,1,20, _targModel, true,0.915, false, true, false, false));
		addModel(new RegressionPosToPrClick(_rConnection, _querySpace, false,3,40, _targModel, true,0.99, false, true, false, false));
		addModel(new RegressionPosToPrClick(_rConnection, _querySpace, false,3,60, _targModel, true,0.99, false, true, false, false));
		addModel(new RegressionPosToPrClick(_rConnection, _querySpace, false,3,40, _targModel, false,0.84, false, true, false, false));
		...
		for(int i = 1; i < 20; i++) {
			addModel(new WEKAClassifPosToPrClick(i));
		}
	}
	...
	public AbstractModel getCopy() {
		return new KitchenSinkEnsemblePosToPrClick(_querySpace, NUMPASTDAYS, ENSEMBLESIZE, _targModel, _borda, _ignoreNaN);
	}
