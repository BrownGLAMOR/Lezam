...
public class EnsembleBidToPos extends AbstractBidToPos {
   ...
   public void initializeEnsemble() {
      ...
      addModel(new RegressionBidToPos(_rConnection, _querySpace, true, 1, 40, true, 0.84, false, false, false, false));
      addModel(new RegressionBidToPos(_rConnection, _querySpace, true, 1, 60, true, 0.915, false, false, false, false));
      addModel(new RegressionBidToPos(_rConnection, _querySpace, true, 1, 40, true, 0.915, false, false, false, false));
      addModel(new RegressionBidToPos(_rConnection, _querySpace, true, 1, 40, true, 0.99, false, false, false, false));
      addModel(new RegressionBidToPos(_rConnection, _querySpace, true, 1, 40, false, 0.84, false, false, false, false));
      addModel(new RegressionBidToPos(_rConnection, _querySpace, true, 1, 60, true, 0.99, false, false, false, false));
      addModel(new RegressionBidToPos(_rConnection, _querySpace, false, 1, 60, true, 0.915, true, false, false, false));
      addModel(new RegressionBidToPos(_rConnection, _querySpace, false, 1, 40, true, 0.915, true, false, false, false));
      addModel(new RegressionBidToPos(_rConnection, _querySpace, false, 1, 60, true, 0.84, true, false, false, false));
      addModel(new RegressionBidToPos(_rConnection, _querySpace, false, 1, 40, true, 0.84, true, false, false, false));
      addModel(new RegressionBidToPos(_rConnection, _querySpace, false, 1, 20, true, 0.915, true, false, false, false));
      addModel(new RegressionBidToPos(_rConnection, _querySpace, false, 1, 20, true, 0.84, true, false, false, false));
//		addModel(new RegressionBidToPos(_rConnection, _querySpace, true,1,60, false,0.84, false, false, false, false));
//		addModel(new RegressionBidToPos(_rConnection, _querySpace, false,1,20, true,0.99, true, false, false, false));
//		addModel(new RegressionBidToPos(_rConnection, _querySpace, false,1,20, false,0.84, true, false, false, false));
//		addModel(new RegressionBidToPos(_rConnection, _querySpace, false,1,60, true,0.99, true, false, false, false));
//		addModel(new RegressionBidToPos(_rConnection, _querySpace, false,1,40, true,0.99, true, false, false, false));
//		addModel(new RegressionBidToPos(_rConnection, _querySpace, false,1,60, false,0.84, true, false, false, false));
//		addModel(new RegressionBidToPos(_rConnection, _querySpace, false,1,40, false,0.84, true, false, false, false));
//		addModel(new RegressionBidToPos(_rConnection, _querySpace, false,1,20, true,0.915, false, false, false, false));
//		addModel(new RegressionBidToPos(_rConnection, _querySpace, false,1,40, true,0.84, false, false, false, false));
//		addModel(new RegressionBidToPos(_rConnection, _querySpace, false,1,60, true,0.84, false, false, false, false));
//		addModel(new RegressionBidToPos(_rConnection, _querySpace, false,1,20, true,0.84, false, false, false, false));
//		addModel(new RegressionBidToPos(_rConnection, _querySpace, false,1,20, true,0.99, false, false, false, false));
//		addModel(new RegressionBidToPos(_rConnection, _querySpace, false,1,40, true,0.915, false, false, false, false));
//		addModel(new RegressionBidToPos(_rConnection, _querySpace, false,1,20, false,0.84, false, false, false, false));
//		addModel(new RegressionBidToPos(_rConnection, _querySpace, false,1,60, true,0.915, false, false, false, false));
//		addModel(new RegressionBidToPos(_rConnection, _querySpace, true,3,40, false,0.84, false, false, false, false));
//		addModel(new RegressionBidToPos(_rConnection, _querySpace, true,3,60, true,0.915, false, false, false, false));
//		addModel(new RegressionBidToPos(_rConnection, _querySpace, false,1,40, true,0.99, false, false, false, false));
//		addModel(new RegressionBidToPos(_rConnection, _querySpace, false,1,40, false,0.84, false, false, false, false));
//		addModel(new RegressionBidToPos(_rConnection, _querySpace, false,1,60, true,0.99, false, false, false, false));
//		addModel(new RegressionBidToPos(_rConnection, _querySpace, false,1,60, false,0.84, false, false, false, false));
//		addModel(new RegressionBidToPos(_rConnection, _querySpace, true,3,60, true,0.99, false, false, false, false));
//		addModel(new RegressionBidToPos(_rConnection, _querySpace, true,3,60, false,0.84, false, false, false, false));
//		addModel(new RegressionBidToPos(_rConnection, _querySpace, false,3,60, true,0.99, true, false, false, false));
//		addModel(new RegressionBidToPos(_rConnection, _querySpace, false,3,60, false,0.84, true, false, false, false));
//		addModel(new RegressionBidToPos(_rConnection, _querySpace, false,3,60, true,0.915, true, false, false, false));
//		addModel(new RegressionBidToPos(_rConnection, _querySpace, true,3,60, true,0.84, false, false, false, false));
//		addModel(new RegressionBidToPos(_rConnection, _querySpace, false,3,40, true,0.99, true, false, false, false));
//		addModel(new RegressionBidToPos(_rConnection, _querySpace, false,3,40, true,0.915, true, false, false, false));
//		addModel(new RegressionBidToPos(_rConnection, _querySpace, false,3,40, false,0.84, true, false, false, false));
//		addModel(new RegressionBidToPos(_rConnection, _querySpace, false,3,20, true,0.99, true, false, false, false));
//		addModel(new RegressionBidToPos(_rConnection, _querySpace, false,3,20, false,0.84, true, false, false, false));
//		addModel(new RegressionBidToPos(_rConnection, _querySpace, false,3,20, true,0.915, true, false, false, false));
//		addModel(new RegressionBidToPos(_rConnection, _querySpace, false,3,60, true,0.84, true, false, false, false));
//		addModel(new RegressionBidToPos(_rConnection, _querySpace, false,3,40, true,0.84, true, false, false, false));
//		addModel(new RegressionBidToPos(_rConnection, _querySpace, false,3,20, true,0.84, true, false, false, false));
//		addModel(new RegressionBidToPos(_rConnection, _querySpace, false,4,60, false,0.84, true, false, false, false));
   }
