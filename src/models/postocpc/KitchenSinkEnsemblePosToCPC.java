...
public class KitchenSinkEnsemblePosToCPC extends AbstractPosToCPC {
	...
	public KitchenSinkEnsemblePosToCPC(Set<Query> querySpace, int numPastDays, int ensembleSize, boolean borda, boolean ignoreNaN) {
	...
	public void initializeEnsemble() {
		...
		addModel(new RegressionPosToCPC(_rConnection, _querySpace, false,1,60, true,0.915, false, false, true, false, false, false));
		addModel(new RegressionPosToCPC(_rConnection, _querySpace, false,1,20, true,0.99, false, false, true, false, false, false));
		addModel(new RegressionPosToCPC(_rConnection, _querySpace, false,1,20, false,0.84, false, false, true, false, false, false));
		addModel(new RegressionPosToCPC(_rConnection, _querySpace, false,1,40, true,0.99, false, false, true, false, false, false));
		addModel(new RegressionPosToCPC(_rConnection, _querySpace, true,1,40, true,0.99, false, false, false, false, false, false));
		addModel(new RegressionPosToCPC(_rConnection, _querySpace, false,1,60, true,0.915, false, false, true, false, true, false));
		addModel(new RegressionPosToCPC(_rConnection, _querySpace, false,1,40, true,0.915, false, false, true, false, true, false));
		addModel(new RegressionPosToCPC(_rConnection, _querySpace, false,1,60, true,0.99, false, false, true, false, false, false));
		addModel(new RegressionPosToCPC(_rConnection, _querySpace, false,1,40, false,0.84, false, false, true, false, false, false));
		addModel(new RegressionPosToCPC(_rConnection, _querySpace, true,1,60, true,0.99, false, false, false, false, false, false));
		addModel(new RegressionPosToCPC(_rConnection, _querySpace, true,1,40, false,0.84, false, false, false, false, false, false));
		addModel(new RegressionPosToCPC(_rConnection, _querySpace, false,1,20, true,0.915, false, false, true, false, true, false));
		addModel(new RegressionPosToCPC(_rConnection, _querySpace, false,1,60, false,0.84, false, false, true, false, false, false));
		addModel(new RegressionPosToCPC(_rConnection, _querySpace, true,1,60, false,0.84, false, false, false, false, false, false));
		addModel(new RegressionPosToCPC(_rConnection, _querySpace, false,1,60, true,0.84, false, false, true, false, true, false));
		addModel(new RegressionPosToCPC(_rConnection, _querySpace, false,1,40, true,0.84, false, false, true, false, true, false));
		addModel(new RegressionPosToCPC(_rConnection, _querySpace, false,1,20, true,0.84, false, false, true, false, true, false));
		addModel(new RegressionPosToCPC(_rConnection, _querySpace, false,1,20, true,0.99, false, false, true, false, true, false));
		addModel(new RegressionPosToCPC(_rConnection, _querySpace, false,1,20, false,0.84, false, false, true, false, true, false));
		addModel(new RegressionPosToCPC(_rConnection, _querySpace, false,1,20, true,0.84, false, false, false, false, false, false));
		addModel(new RegressionPosToCPC(_rConnection, _querySpace, false,1,40, true,0.84, false, false, false, false, false, false));
		addModel(new RegressionPosToCPC(_rConnection, _querySpace, false,1,60, true,0.84, false, false, false, false, false, false));
		addModel(new RegressionPosToCPC(_rConnection, _querySpace, false,1,40, true,0.99, false, false, true, false, true, false));
		addModel(new RegressionPosToCPC(_rConnection, _querySpace, false,1,20, true,0.915, false, false, false, false, false, false));
		addModel(new RegressionPosToCPC(_rConnection, _querySpace, false,1,40, false,0.84, false, false, true, false, true, false));
		addModel(new RegressionPosToCPC(_rConnection, _querySpace, false,1,40, true,0.915, false, false, false, false, false, false));
		addModel(new RegressionPosToCPC(_rConnection, _querySpace, false,1,60, true,0.915, false, false, false, false, false, false));
		addModel(new RegressionPosToCPC(_rConnection, _querySpace, false,1,60, true,0.99, false, false, true, false, true, false));
		addModel(new RegressionPosToCPC(_rConnection, _querySpace, false,1,20, true,0.99, false, false, false, false, false, false));
		addModel(new RegressionPosToCPC(_rConnection, _querySpace, false,1,20, false,0.84, false, false, false, false, false, false));
		addModel(new RegressionPosToCPC(_rConnection, _querySpace, false,1,60, false,0.84, false, false, true, false, true, false));
		addModel(new RegressionPosToCPC(_rConnection, _querySpace, false,1,40, true,0.99, false, false, false, false, false, false));
		addModel(new RegressionPosToCPC(_rConnection, _querySpace, false,1,60, true,0.99, false, false, false, false, false, false));
		...
		for(int i = 1; i < 20; i++) {
			addModel(new WEKAClassifPosToCPC(i));
		}
	}
	...
	public String toString() {
		return "WEKAEnsemblePosToCPC(" + "numPastDays: " + NUMPASTDAYS + ", ensemble size: " + ENSEMBLESIZE + ", borda count: " + _borda + ", ignoreNaN: " + _ignoreNaN + ")";
	}
	...
	public AbstractModel getCopy() {
		return new KitchenSinkEnsemblePosToCPC(_querySpace, NUMPASTDAYS, ENSEMBLESIZE, _borda, _ignoreNaN);
	}
