...
public class HistoricalDailyAverageUserModel extends AbstractUserModel {
   ...
   private int getProdIdx(String manufacturerString, String componentString) {
      ...
      if (manufacturerString.equalsIgnoreCase("lioneer")) {
         manIdx = 0;
      }
      if (manufacturerString.equalsIgnoreCase("pg")) {
         manIdx = 1;
      }
      if (manufacturerString.equalsIgnoreCase("flat")) {
         manIdx = 2;
      }

      if (componentString.equalsIgnoreCase("tv")) {
         compIdx = 0;
      }
      if (componentString.equalsIgnoreCase("dvd")) {
         compIdx = 1;
      }
      if (componentString.equalsIgnoreCase("audio")) {
         compIdx = 2;
      }

      if (manIdx == -1 || compIdx == -1) {
         System.out.println("Error! No match for " + manufacturerString + ", " + componentString);
      }
