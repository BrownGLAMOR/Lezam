...
//			System.out.println("bid: " + bid + ", prediction: " +prediction + ", mean or mode: ");
   ...
   public String toString() {
      switch (_idx) {
         case 1:
            return "WEKAClassifBidToPrClick(BayesNet)";
         case 2:
            return "WEKAClassifBidToPrClick(NaiveBayes)";
         case 3:
            return "WEKAClassifBidToPrClick(IBk)";
         case 4:
            return "WEKAClassifBidToPrClick(KStar)";
         case 5:
            return "WEKAClassifBidToPrClick(LWL)";
         case 6:
            return "WEKAClassifBidToPrClick(AttributeSelectedClassifier)";
         case 7:
            return "WEKAClassifBidToPrClick(Bagging)";
         case 8:
            return "WEKAClassifBidToPrClick(LogitBoost)";
         case 9:
            return "WEKAClassifBidToPrClick(RandomCommittee)";
         case 10:
            return "WEKAClassifBidToPrClick(DecisionTable)";
         case 11:
            return "WEKAClassifBidToPrClick(DTNB)";
         case 12:
            return "WEKAClassifBidToPrClick(NNge)";
         case 13:
            return "WEKAClassifBidToPrClick(OneR)";
         case 14:
            return "WEKAClassifBidToPrClick(PART)";
         case 15:
            return "WEKAClassifBidToPrClick(J48)";
         case 16:
            return "WEKAClassifBidToPrClick(J48graft)";
         case 17:
            return "WEKAClassifBidToPrClick(NBTree)";
         case 18:
            return "WEKAClassifBidToPrClick(RandomForest)";
         case 19:
            return "WEKAClassifBidToPrClick(REPTree)";
         default:
            return "WEKAClassifBidToPrClick(NaiveBayes)";
      }
   }
