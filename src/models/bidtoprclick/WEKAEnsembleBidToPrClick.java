...
public class WEKAEnsembleBidToPrClick extends AbstractBidToPrClick {
	...
	public AbstractModel getCopy() {
		return new WEKAEnsembleBidToPrClick(_querySpace, NUMPASTDAYS, ENSEMBLESIZE, _targModel, _borda, _ignoreNaN);
	}
