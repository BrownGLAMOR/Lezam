...
//			e.printStackTrace();
   ...
   public String toString() {
      switch (_idx) {
         case 1:
            return "WEKABidToPrClick(LinearRegression), weight: " + _weight + ")";
         case 2:
            return "WEKABidToPrClick(IBk), weight: " + _weight + ")";
         case 3:
            return "WEKABidToPrClick(KStar), weight: " + _weight + ")";
         case 4:
            return "WEKABidToPrClick(LWL), weight: " + _weight + ")";
         case 5:
            return "WEKABidToPrClick(AdditiveRegression), weight: " + _weight + ")";
         case 6:
            return "WEKABidToPrClick(REPTree), weight: " + _weight + ")";
         case 7:
            return "WEKABidToPrClick(RegressionByDiscretization), weight: " + _weight + ")";
         default:
            return "WEKABidToPrClick(LinearRegression), weight: " + _weight + ")";
      }
   }
